...
('Milton\'s Quest', 19.99, 'Aventura de acción y plataformas donde encarnas a Milton, un joven elefante que explora la jungla de Borneo buscando a su abuelo desaparecido. Adéntrate en el antiguo templo de Mudkara, hogar de los Mudlers, una raza ancestral de seres de arcilla. Usa tu trompa para disparar agua y enfrentar hordas de enemigos mientras buscas pistas sobre el paradero de tu abuelo. Explora más de 40 niveles llenos de trampas, plataformas desafiantes y puzzles ambientales. Roba tesoros del templo para mejorar tus habilidades de combate y desbloquear poderes especiales. Sistema de combate fluido combinando disparos de agua con ataques cuerpo a cuerpo. Enfrenta jefes épicos Mudler que requieren estrategia y reflejos precisos. Arte dibujado a mano con estilo cartoon vibrante y banda sonora orquestal con toques étnicos. Modo historia de 10-15 horas perfecta para fans de plataformas clásicas.', 'juego', '/assets/imagenes/videojuegos/miltonsQuest.jpg'),
...
('Nintendo Switch 2', 499.99, 'Versión mejorada de Nintendo Switch con batería de larga duración (4.5-9 horas vs 2.5-6.5 del modelo original). Procesador Tegra X1+ optimizado que consume menos energía y mejora el rendimiento. Pantalla LCD de 6.2 pulgadas con mejor brillo. Juega en tres modos: TV con hasta 1080p, sobremesa o portátil. Joy-Cons mejorados con HD Rumble y motion controls precisos. Almacenamiento de 32GB ampliable con microSD hasta 2TB. Accede a toda la biblioteca de exclusivos Nintendo: Zelda, Mario, Pokémon, Splatoon y miles de juegos indie. Multijugador local para hasta 8 consolas sin WiFi. Compatible con Nintendo Switch Online para juego online y catálogo retro. Dock incluido con salida HDMI. Conectividad Bluetooth para auriculares. La consola híbrida perfecta para gaming flexible en casa y en movimiento.', 'consola', '/assets/imagenes/consolas/switch2.jpg');
