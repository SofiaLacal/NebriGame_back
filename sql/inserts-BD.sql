...
('Street Fighter 6', 69.99, 'Última entrega de la legendaria saga de lucha con 18 luchadores al lanzamiento y modo World Tour innovador. Explora Metro City en un modo historia open-world creando tu propio avatar y aprendiendo técnicas. Sistema de combate renovado con Drive Gauge que unifica mecánicas ofensivas y defensivas. Gráficos impresionantes con motor RE Engine, comentarios dinámicos en tiempo real y música hip-hop/electrónica. Modo Arcade clásico, VS local/online, Battle Hub social y torneos ranked. Netcode rollback perfecto con crossplay completo entre plataformas. Contenido post-lanzamiento con 4 pases de temporada planificados.', 'juego', '/assets/imagenes/videojuegos/streetFighter6.jpg'),
...
(34, '825GB SSD', 'Blanco y Negro', 'Sony', 1, 10),
(35, '1TB SSD', 'Negro', 'Microsoft', 2, 8),
(36, '64GB', 'Blanco', 'Nintendo', 3, 12),
(37, '825GB SSD', 'Blanco y Negro', 'Sony', 1, 5),
(38, '512GB SSD', 'Negro', 'Microsoft', 2, 15),
(39, '256GB SSD', 'Negro', 'Valve', 7, 7),
(40, '128GB', 'Blanco', 'Meta', 8, 6),
(41, '32GB', 'Turquesa', 'Nintendo', 3, 18),
(42, '1TB HDD', 'Negro', 'Sony', 5, 12),
...
(46, 'Ropa', 50),                 -- Camiseta Zelda
(47, 'Figuras', 30),              -- Funko Mario
(48, 'Accesorios', 25),           -- Mando DualSense
(49, 'Decoración', 100),          -- Poster Elden Ring
(50, 'Accesorios', 40),           -- Funda Switch
(51, 'Accesorios', 60),           -- Llavero PS
(52, 'Decoración', 35),           -- Taza Minecraft
(53, 'Accesorios', 20),           -- Mochila Gaming
(54, 'Accesorios', 28),           -- Alfombrilla Cyberpunk
(55, 'Accesorios', 18),           -- Auriculares Gaming
(56, 'Decoración', 45),           -- Lámpara Pac-Man
(57, 'Accesorios', 55),           -- Set Pins
(58, 'Tarjetas Digitales', 100),  -- PSN 50€
(59, 'Tarjetas Digitales', 100),  -- Xbox 25€
(60, 'Tarjetas Digitales', 100),  -- eShop 35€
(61, 'Tarjetas Digitales', 100),  -- Steam 20€
(62, 'Accesorios', 50),           -- Cable HDMI
(63, 'Accesorios', 30),           -- Soporte Consolas
(64, 'Accesorios', 35),           -- Cargador Dual PS5
(65, 'Decoración', 80),           -- Pegatinas Gamer
(66, 'Libros', 25),               -- Artbook Zelda
(67, 'Libros', 30),               -- Guía Elden Ring
(68, 'Figuras', 40),              -- amiibo Link
(69, 'Figuras', 45),              -- amiibo Mario
(70, 'Accesorios', 20),           -- Pro Controller
(71, 'Accesorios', 60),           -- Kit Limpieza
(72, 'Figuras', 35),              -- Peluche Psyduck
(73, 'Figuras', 28),              -- Figura Psyduck
...
(1, 34, 0, 1),  -- Juan: PS5 Standard (consola: plataforma_id=0)
(2, 3, 1, 2),   -- María: 2x FIFA (PS5)
(2, 46, 0, 1),  -- María: Camiseta Zelda (merchandising: plataforma_id=0)
(3, 2, 1, 1),   -- Carlos: Elden Ring (PS5)
(3, 48, 0, 2),  -- Carlos: 2x Mando DualSense (merchandising)
(4, 36, 0, 1),  -- Ana: Switch OLED (consola)
...
(1, 35),  -- Juan quiere Xbox Series X
(1, 53),  -- Juan quiere Mochila Gaming
(2, 34),  -- María quiere PS5
(2, 4),   -- María quiere Call of Duty
(2, 55),  -- María quiere Auriculares Gaming
(3, 34),  -- Carlos quiere PS5
(3, 1),   -- Carlos quiere Zelda
(3, 36),  -- Carlos quiere Switch OLED
(4, 2),   -- Ana quiere Elden Ring
(4, 7),   -- Ana quiere Red Dead 2
(5, 34),  -- Luis quiere PS5
(5, 3),   -- Luis quiere FIFA
(5, 39),  -- Luis quiere Steam Deck
...
(1, 34, NULL, 1, 549.99, 549.99),  -- PS5 Standard (consola)
...
(3, 48, NULL, 2, 19.99, 39.98);   -- 2x Mando DualSense (merchandising)

-- Pedido 4: 
INSERT INTO pedidos_productos (pedido_id, producto_id, plataforma_id, cantidad, precio_unitario, subtotal) VALUES
(4, 36, NULL, 1, 349.99, 349.99), -- Switch OLED (consola)
(4, 5, 3, 1, 59.99, 59.99);       -- Mario Odyssey (Switch)

-- Pedido 5: 
INSERT INTO pedidos_productos (pedido_id, producto_id, plataforma_id, cantidad, precio_unitario, subtotal) VALUES
(5, 46, NULL, 1, 24.99, 24.99);   -- Camiseta Zelda (merchandising)

-- Pedido 6: 
INSERT INTO pedidos_productos (pedido_id, producto_id, plataforma_id, cantidad, precio_unitario, subtotal) VALUES
(6, 8, 1, 1, 29.99, 29.99),       -- Minecraft (PS5)
(6, 52, NULL, 1, 12.99, 12.99),   -- Taza Minecraft (merchandising)
(6, 49, NULL, 1, 9.99, 9.99);     -- Poster Elden Ring (merchandising)

-- Pedido 7: 
INSERT INTO pedidos_productos (pedido_id, producto_id, plataforma_id, cantidad, precio_unitario, subtotal) VALUES
(7, 37, NULL, 1, 449.99, 449.99), -- PS5 Digital (consola)
